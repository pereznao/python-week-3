...
print(name + " liked to hum the song " + song +
      " while coding. It was so annoying that their teammates would throw " +
...
print(type(num1))
print(type(num2))
#python knows a lot of number ty[es implicitly without you directly telling it(explicit)
...
age = "30"
print(type(age))
age = int(age)  ###telling python to convert to an int instead of str
print(type(age))
...
associate_name = "jesse pinkman"
associate_number = 399058
associate_number = str(associate_number)
...
print(
    f"{user} , you have earned {new_points} points! In total, you have accumulated {total_points} points!"
)
